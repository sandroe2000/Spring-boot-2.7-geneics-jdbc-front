...
export class Home {
    ...
    async init(){
        ...
        Split(['#rightTopPanel', '#rightBottomPanel'], {
            ...
            onDrag: function (sizes) { 
                ...
                document.querySelector('#cardResult').style.height = `${document.querySelector('#rightBottomPanel').offsetHeight - 90}px`;
                document.querySelector('#cardParameters').style.height = `${document.querySelector('#rightBottomPanel').offsetHeight - 90}px`;
            }
        });
    ...
    async saveFileSql(){
        ...
        //if(Object.keys(this.obj.result).length === 0){
